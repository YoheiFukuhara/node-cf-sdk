 ...
 */
export function batch(...requests: Array<ReadCbCustomerServiceRequestBuilder | ODataBatchChangeSet<WriteCbCustomerServiceRequestBuilder>>): ODataBatchRequestBuilder {
  return new ODataBatchRequestBuilder(defaultCbCustomerServicePath, requests, map);
}
