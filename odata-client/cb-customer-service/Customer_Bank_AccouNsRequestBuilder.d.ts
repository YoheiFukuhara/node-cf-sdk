 ...
 */
export declare class Customer_Bank_AccouNsRequestBuilder extends RequestBuilder<Customer_Bank_AccouNs> {
    /**
...
//# sourceMappingURL=Customer_Bank_AccouNsRequestBuilder.d.ts.map