 ...
 */
export class Customer_Comp_CodEsRequestBuilder extends RequestBuilder<Customer_Comp_CodEs> {
  /**
  ...
  getByKey(customerCc: string, companyCode: string): GetByKeyRequestBuilder<Customer_Comp_CodEs> {
    return new GetByKeyRequestBuilder(Customer_Comp_CodEs, {
  ...
  getAll(): GetAllRequestBuilder<Customer_Comp_CodEs> {
    return new GetAllRequestBuilder(Customer_Comp_CodEs);
  }
}
