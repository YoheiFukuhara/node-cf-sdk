 ...
 */
export class Customer_Sales_AreAsRequestBuilder extends RequestBuilder<Customer_Sales_AreAs> {
  /**
  ...
  getByKey(salesOrganization: string, distributionChannel: string, division: string): GetByKeyRequestBuilder<Customer_Sales_AreAs> {
    return new GetByKeyRequestBuilder(Customer_Sales_AreAs, {
  ...
  getAll(): GetAllRequestBuilder<Customer_Sales_AreAs> {
    return new GetAllRequestBuilder(Customer_Sales_AreAs);
  }
}
