 ...
 */
export class CustomersRequestBuilder extends RequestBuilder<Customers> {
  /**
  ...
  getByKey(customer: string): GetByKeyRequestBuilder<Customers> {
    return new GetByKeyRequestBuilder(Customers, { Customer: customer });
  }
  ...
  getAll(): GetAllRequestBuilder<Customers> {
    return new GetAllRequestBuilder(Customers);
  }
}
