 ...
 */
export class SalesGroupContractsRequestBuilder extends RequestBuilder<SalesGroupContracts> {
  /**
  ...
  getByKey(salesGroupContract: string): GetByKeyRequestBuilder<SalesGroupContracts> {
    return new GetByKeyRequestBuilder(SalesGroupContracts, { SalesGroupContract: salesGroupContract });
  }
  ...
  getAll(): GetAllRequestBuilder<SalesGroupContracts> {
    return new GetAllRequestBuilder(SalesGroupContracts);
  }
}
