 ...
 */
export class SalesOrdersRequestBuilder extends RequestBuilder<SalesOrders> {
  /**
  ...
  getByKey(salesOrder: string): GetByKeyRequestBuilder<SalesOrders> {
    return new GetByKeyRequestBuilder(SalesOrders, { SalesOrder: salesOrder });
  }
  ...
  getAll(): GetAllRequestBuilder<SalesOrders> {
    return new GetAllRequestBuilder(SalesOrders);
  }
}
