 ...
 */
export class SalesQuotationsRequestBuilder extends RequestBuilder<SalesQuotations> {
  /**
  ...
  getByKey(salesQuotation: string): GetByKeyRequestBuilder<SalesQuotations> {
    return new GetByKeyRequestBuilder(SalesQuotations, { SalesQuotation: salesQuotation });
  }
  ...
  getAll(): GetAllRequestBuilder<SalesQuotations> {
    return new GetAllRequestBuilder(SalesQuotations);
  }
}
